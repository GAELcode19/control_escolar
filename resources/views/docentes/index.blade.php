...
<div class="flex flex-col gap-6 p-6">
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <a href="#" class="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 transition text-white text-sm font-medium px-4 py-2 rounded-lg">
                ...
                <tr class="hover:bg-white/5 transition group">
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-gray-400 text-xs">{{ $docente->email }}</p>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-gray-300 font-mono text-xs">{{ $docente->rfc ?? $docente->clave }}</td>
                    ...
                    <td class="px-6 py-4 text-right">
                        <div class="flex items-center justify-end gap-2 opacity-0 group-hover:opacity-100 transition">
                            <a href="#" class="p-1.5 rounded-lg hover:bg-indigo-500/20 text-gray-400 hover:text-indigo-400 transition" title="Editar">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <a href="#" class="p-1.5 rounded-lg hover:bg-red-500/20 text-gray-400 hover:text-red-400 transition" title="Eliminar">
                                <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <tr>
                    <td colspan="5" class="px-6 py-16 text-center">
                        <div class="flex flex-col items-center gap-3 text-gray-500">
                            ...
                            <p class="text-sm">No hay docentes registrados aún.</p>
                            <a href="#" class="text-indigo-400 hover:underline text-xs">+ Agregar el primero</a>
                        </div>
                    </td>
                </tr>
                @endforelse
